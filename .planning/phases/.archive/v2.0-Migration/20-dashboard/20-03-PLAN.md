...
3. **Design Reference Images** (MANDATORY for UI work):
   - `./.planning/phases/17-design-system/design4` (Flash UI - primary)
...
2. ./perm_flow.md
3. ./.planning/phases/20-dashboard/20-CONTEXT.md
4. ./.planning/V2_DEADLINE_SYSTEM.md
5. v2/docs/DESIGN_SYSTEM.md
6. ./.planning/phases/17-design-system/design3
7. ./.planning/phases/17-design-system/design4
8. ./.planning/phases/17-design-system/design5
```
