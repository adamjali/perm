...
3. **Design Reference Images** (MANDATORY for UI work):
   ...
   - `./.planning/phases/17-design-system/design4` (Flash UI - primary reference)
...
1. ./.planning/FRONTEND_DESIGN_SKILL.md (design rules, colors, typography)
2. ./perm_flow.md (PERM workflow, statuses, deadline logic)
3. ./.planning/phases/17-design-system/design3 (design reference)
4. ./.planning/phases/17-design-system/design4 (Flash UI - primary reference)
5. ./.planning/phases/17-design-system/design5 (design reference)
6. v2/docs/DESIGN_SYSTEM.md (component library)
7. ./.planning/phases/20-dashboard/20-CONTEXT.md (phase context)
```
