...
| Doc | Path | Purpose |
|-----|------|---------|
| perm_flow.md | `./perm_flow.md` | SOURCE OF TRUTH for deadlines, statuses |
| v2/CLAUDE.md | `./v2/CLAUDE.md` | API patterns, imports, anti-patterns |
| frontend-design skill (its a plug-in) | `./.planning/FRONTEND_DESIGN_SKILL.md` | UI work guidelines |
| Design docs | `./.planning/phases/17-design-system/design*` | Visual references |
...
- `./perm_flow.md` - SOURCE OF TRUTH
- `./v2/CLAUDE.md` - API patterns
- [Other relevant docs]
