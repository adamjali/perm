...
| Doc | Path | Purpose |
|-----|------|---------|
| perm_flow.md | `/Users/dev/cc/perm-tracker-test/perm_flow.md` | SOURCE OF TRUTH for deadlines, statuses |
| v2/CLAUDE.md | `/Users/dev/cc/perm-tracker-test/v2/CLAUDE.md` | API patterns, imports, anti-patterns |
| frontend-design skill (its a plug-in) | `/Users/dev/cc/perm-tracker-test/.planning/FRONTEND_DESIGN_SKILL.md` | UI work guidelines |
| Design docs | `/Users/dev/cc/perm-tracker-test/.planning/phases/17-design-system/design*` | Visual references |
...
- `/Users/dev/cc/perm-tracker-test/perm_flow.md` - SOURCE OF TRUTH
- `/Users/dev/cc/perm-tracker-test/v2/CLAUDE.md` - API patterns
- [Other relevant docs]
