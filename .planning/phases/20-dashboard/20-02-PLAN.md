...
1. **Frontend Design Skill** (MANDATORY):
   - `/Users/dev/cc/perm-tracker-test/.planning/FRONTEND_DESIGN_SKILL.md`
...
2. **PERM Flow Source of Truth** (MANDATORY):
   - `/Users/dev/cc/perm-tracker-test/perm_flow.md`
   - Defines case statuses, progress statuses, subtext requirements for tiles

3. **Design Reference Images** (MANDATORY for UI work):
   - `/Users/dev/cc/perm-tracker-test/.planning/phases/17-design-system/design3`
   - `/Users/dev/cc/perm-tracker-test/.planning/phases/17-design-system/design4` (Flash UI - primary reference)
   - `/Users/dev/cc/perm-tracker-test/.planning/phases/17-design-system/design5`

4. **Design System Documentation**:
   - `v2/docs/DESIGN_SYSTEM.md` - Component library and utility classes

5. **Phase Context**:
   - `/Users/dev/cc/perm-tracker-test/.planning/phases/20-dashboard/20-CONTEXT.md`
...
1. /Users/dev/cc/perm-tracker-test/.planning/FRONTEND_DESIGN_SKILL.md (design rules, colors, typography)
2. /Users/dev/cc/perm-tracker-test/perm_flow.md (PERM workflow, statuses, deadline logic)
3. /Users/dev/cc/perm-tracker-test/.planning/phases/17-design-system/design3 (design reference)
4. /Users/dev/cc/perm-tracker-test/.planning/phases/17-design-system/design4 (Flash UI - primary reference)
5. /Users/dev/cc/perm-tracker-test/.planning/phases/17-design-system/design5 (design reference)
6. v2/docs/DESIGN_SYSTEM.md (component library)
7. /Users/dev/cc/perm-tracker-test/.planning/phases/20-dashboard/20-CONTEXT.md (phase context)
```
