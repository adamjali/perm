...
For step-by-step instructions on tracking these activities in PERM Tracker, see our [recruitment tracking tutorial](/tutorials/recruitment-tracking). For the broader filing context, see our [complete filing guide](/guides/complete-perm-filing-guide) or the [Ultimate PERM Guide](/guides/ultimate-perm-guide-2026).
