...
- **When DOL will decide the case.** That is a queue forecast, not arithmetic, and it lives in the [processing time calculator](/tools/perm-timeline-calculator). How close it lands is on the [estimate scorecard](/estimate-scorecard).
