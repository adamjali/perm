...
- **The person waiting on a case**: look your own case number up at [PERM case status](/perm-case-status), get an email when DOL changes it, and read the same federal data everyone else is reading. No account, no sign-in.
