...
image: "/images/content/cards/how-dol-sets-a-prevailing-wage.webp"
imageAlt: "90 days, issued 30 June. The next morning, 364, beside one long bar above a much shorter one"
tags: ["prevailing-wage", "pwd", "eta-9141", "oews", "wage-levels", "dol", "explainer"]
category: "data"
seoTitle: "Prevailing Wage Timeline for PERM"
...
- **How fast DOL clears the backlog.** It publishes the size of the pile, not the rate it moves. Where a date is estimated on this site it's graded against real decisions on the [estimate scorecard](/estimate-scorecard).
