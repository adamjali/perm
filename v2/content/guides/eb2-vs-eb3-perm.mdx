...
category: "reference"
seoTitle: "EB-2 vs EB-3 on a PERM: Which Category"
...
[The priority date history](/tools/priority-date-calculator) shows both categories for each country over every bulletin since October 2014, including the months where the order reversed, and [the I-485 queue position](/tools/i485-queue-position) shows how many applicants USCIS had pending ahead of a date in each.
