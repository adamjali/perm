...
image: "/images/content/photos/capitol-columns.webp"
imageAlt: "PERM Tracker, showing DOL's current queue position"
tags: ["perm", "pwd", "i-140", "i-485", "green-card", "guide", "beneficiary"]
category: "data"
seoTitle: "Employer-Sponsored Green Card: The Process"
seoDescription: "Every step of an employment green card, what each takes right now, and how to check your own case with the Department of Labor and USCIS."
featured: true
published: true
---
...
**About estimates.** Any date anyone gives you for your PERM is an estimate built on how fast DOL has been moving. Ours is graded against real decisions on the [estimate scorecard](/estimate-scorecard). Treat a predicted month as a rough centre, not a date to plan around.
...
**How to check.** The [priority date tool](/tools/priority-date-calculator) holds every cutoff since October 2014, so you can see not just where the line is but which way it's been moving. That direction matters more than the current number.
...
- [Why cases are denied or audited](/blog/why-perm-cases-are-denied)
...
- [What to do while you wait](/blog/what-to-do-while-you-wait)
