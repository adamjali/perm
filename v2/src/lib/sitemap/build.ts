...
export async function pagesEntries(): Promise<Entry[]> {
  ...
  const statics: Entry[] = [
    ...
    { url: `${base}/tools/rfi-deadline`, lastModified: "2026-09-09" },
    { url: `${base}/tools/pwd-validity`, lastModified: "2026-09-09" },
    ...
    { url: `${base}/badges`, lastModified: "2026-09-09" },
    { url: `${base}/layoffs`, lastModified: dol ?? "2026-09-09" },
    { url: `${base}/visa-bulletin/family`, lastModified: dol ?? "2026-09-09" },
