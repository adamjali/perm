...
export const PAGE_CARD_ALT = {
  ...
  "green-card-line": "Your place in the green card line. Everyone ahead of a priority date in EB-2, EB-3 and EB-3 Other Workers, by country, as a range.",
  "eb2-vs-eb3": "EB-2 or EB-3 for one priority date. Both lines side by side: this month's cutoffs and the people ahead in each.",
  "which-green-card": "Which employment green card fits. A few questions about the job and you, matched against the regulation's definitions, with what each category needs.",
  ...
  "i140-awaiting-visa": "Approved and waiting for a visa number. USCIS's count of approved I-140, I-360 and I-526 petitions by category and country of birth, with the change since the last count.",
