...
export function FolderOpenSVG({ className = "", size = 200 }: FolderOpenSVGProps) {
  return (
    ...
    >
      ...
      <rect x="50" y="75" width="85" height="25" fill="var(--card)" stroke="currentColor" strokeWidth="2" transform="rotate(2, 92, 87)" />
      ...
      <g transform="translate(155, 35)">
        <path d="M0 -8 L2 -2 L8 0 L2 2 L0 8 L-2 2 L-8 0 L-2 -2 Z" fill="var(--primary)" />
      </g>

      {/* Star 2 - top left */}
      <g transform="translate(40, 28)">
        <path d="M0 -6 L1.5 -1.5 L6 0 L1.5 1.5 L0 6 L-1.5 1.5 L-6 0 L-1.5 -1.5 Z" fill="var(--primary)" opacity="0.7" />
      </g>

      {/* Star 3 - right */}
      <g transform="translate(178, 75)">
        <path d="M0 -5 L1 -1 L5 0 L1 1 L0 5 L-1 1 L-5 0 L-1 -1 Z" fill="var(--primary)" opacity="0.5" />
      </g>

      {/* Plus signs */}
      <g transform="translate(170, 50)" opacity="0.4">
        <line x1="0" y1="-5" x2="0" y2="5" stroke="var(--primary)" strokeWidth="2" />
        <line x1="-5" y1="0" x2="5" y2="0" stroke="var(--primary)" strokeWidth="2" />
      </g>
