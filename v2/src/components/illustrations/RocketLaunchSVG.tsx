...
export function RocketLaunchSVG({ className = "", size = 200 }: RocketLaunchSVGProps) {
  return (
    ...
    >
      ...
      {/* Window */}
      <circle cx="100" cy="90" r="12" fill="var(--stage-pwd)" stroke="currentColor" strokeWidth="3" />
      <circle cx="100" cy="90" r="7" fill="var(--stage-pwd)" stroke="none" />
      {/* Window reflection */}
      <path d="M95 85 Q97 83 100 84" fill="none" stroke="white" strokeWidth="2" opacity="0.6" />

      {/* Rocket stripes */}
      <rect x="80" y="115" width="40" height="6" fill="var(--data-bad)" stroke="currentColor" strokeWidth="1.5" />
      <rect x="80" y="126" width="40" height="6" fill="var(--data-bad)" stroke="currentColor" strokeWidth="1.5" />
      ...
      <g transform="translate(40, 40)">
        <path d="M0 -5 L1.5 -1.5 L5 0 L1.5 1.5 L0 5 L-1.5 1.5 L-5 0 L-1.5 -1.5 Z" fill="var(--primary)" opacity="0.6" />
      </g>
      <g transform="translate(160, 45)">
        <path d="M0 -4 L1 -1 L4 0 L1 1 L0 4 L-1 1 L-4 0 L-1 -1 Z" fill="var(--primary)" opacity="0.4" />
      </g>
    </svg>
  );
}
