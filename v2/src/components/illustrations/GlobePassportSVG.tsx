...
export function GlobePassportSVG({ className = "", size = 200 }: GlobePassportSVGProps) {
  return (
    ...
    >
      {/* Globe */}
      <circle cx="100" cy="90" r="65" fill="var(--primary)" fillOpacity="0.10" stroke="currentColor" strokeWidth="3" />
      ...
      <g transform="translate(145, 48) rotate(30)">
        <path
          ...
          strokeWidth="1.5"
        />
        <line x1="-2" y1="0" x2="-6" y2="0" stroke="var(--primary)" strokeWidth="2" />
      </g>

      {/* Passport - overlapping globe bottom-right */}
      <g transform="translate(125, 120)">
        {/* Passport body */}
        <rect x="0" y="0" width="55" height="72" fill="var(--stage-pwd)" stroke="currentColor" strokeWidth="3" />
