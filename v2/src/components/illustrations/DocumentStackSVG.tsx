...
export function DocumentStackSVG({ className = "", size = 200 }: DocumentStackSVGProps) {
  return (
    ...
    >
      ...
      <rect x="45" y="20" width="120" height="155" fill="var(--muted)" stroke="currentColor" strokeWidth="3" />
      ...
      {/* Middle document */}
      <rect x="32" y="30" width="120" height="155" fill="var(--card)" stroke="currentColor" strokeWidth="3" />
      ...
      {/* Document header bar */}
      <rect x="20" y="40" width="120" height="20" fill="var(--primary)" stroke="currentColor" strokeWidth="3" />
      ...
      <g transform="translate(95, 130) rotate(-15)">
        <rect x="-30" y="-18" width="60" height="36" rx="0" fill="none" stroke="var(--primary)" strokeWidth="3" />
        <text
          x="0"
          y="5"
          textAnchor="middle"
