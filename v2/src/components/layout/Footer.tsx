...
// Brand icon as an inline SVG: neither lucide nor Phosphor ships brand marks
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              {SOCIAL_LINKS.map(({ href, label, icon }) => {
                ...
                // Monochrome, LinkedIn included. Its official #0A66C2 was the
                // honest brand colour and it was still wrong in place: it made
                // the tile the only coloured thing in an otherwise
                // black-and-white footer, on every page, so the eye landed on
                // it before anything the footer is actually for. It also
                // carried brightness-125/150, and a brightness filter used to
                // lift a colour is the glow this project does not ship.
