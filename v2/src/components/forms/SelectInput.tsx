    ...
    return (
      <select
        ...
        className={cn(
          ...
          "h-11 w-full min-w-0 border-2 bg-background px-3 py-1 text-base shadow-hard-sm transition-all duration-150 outline-none md:text-sm appearance-none cursor-pointer dark:bg-input/30",
          // Custom arrow (black for light mode, light gray for dark mode)
