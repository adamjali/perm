    ...
    return (
      <select
        ...
        className={cn(
          ...
          "h-11 w-full border-2 bg-background px-3 py-1 text-base shadow-hard-sm transition-all duration-150 outline-none md:text-sm appearance-none cursor-pointer dark:bg-input/30",
